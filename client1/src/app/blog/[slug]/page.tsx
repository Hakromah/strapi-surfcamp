...
function ArticleOverview({
   ...
   return (
      <div className="md:mx-4 max-md:px-4 flex max-md:gap-4 max-md:flex-col justify-between w-full md:w-[80%] mt-[1rem] max-md:mb-5 md:mb-[6rem]">
         ...
         {tableOfContent && tableOfContent.length > 0 && (
            <div className="w-full md:w-[40%] md:pl-[2rem] md:border-l-[1px] md:border-l-[#ddd]">
               <h4 className="mb-[1rem] text-[#333] font-bold">Table of Contents</h4>
               <ul className="list-none list-inside ">
                  {tableOfContent.map((item, index) => (
                     <li key={index} className="mb-[0.5rem]">
                        <Link href={`#${item.linkId}`} className="hover:underline duration-350 text-blue-600">
